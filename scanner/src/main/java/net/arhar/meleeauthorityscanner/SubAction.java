...
public class SubAction {
  ...
  private static final Map<Integer, SubAction> SUBACTIONS =
      ImmutableMap.<Integer, SubAction>builder()
          ...
          .put(
              0x127,
              new SubAction(
                  ImmutableMap.<Character, SubActionDescription>builder()
          ...
          .put(
              ...
              new SubAction(
                  ImmutableMap.<Character, SubActionDescription>builder()
                      .put(
                          Kp,
                          new SubActionDescription(
                              "Bowser Side-B Hit (Ground)")) //One is forward, other is behind?
              ...
              new SubAction(
                  ImmutableMap.<Character, SubActionDescription>builder()
                      .put(
                          Kp,
                          new SubActionDescription(
                              "Bowser Side-B Hit(2) (Ground)")) //One is forward, other is behind?
          ...
          .put(
              ...
              new SubAction(
                  ImmutableMap.<Character, SubActionDescription>builder()
                      ...
                      .put(
                          Lg, new SubActionDescription("Luigi Side-B(2) (Air)")) // could be misfire
              ...
              new SubAction(
                  ImmutableMap.<Character, SubActionDescription>builder()
                      .put(
                          Kp,
                          new SubActionDescription(
                              "Bowser Side-B Hit (Air)")) //One is forward, other is behind?
              ...
              new SubAction(
                  ImmutableMap.<Character, SubActionDescription>builder()
                      .put(
                          Kp,
                          new SubActionDescription(
                              "Bowser Side-B Hit(2) (Air)")) //One is forward, other is behind?
  ...
  public static final SubActionDescription NO_DESCRIPTION =
      new SubActionDescription("(No Description)");
