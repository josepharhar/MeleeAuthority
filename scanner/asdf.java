...
public class asdf {
  public static void main(String[] args) throws Throwable {
    ...
    MotherCommand gnuptilt =
        new MotherCommand(
            plgn.getInt(), plgn.getInt(), plgn.getInt(), plgn.getInt(), plgn.getInt());
  }
  ...
  private static void overwriteAnimation(
    ...
    sourceAj.targetAj.seek(target.ajPointer);
  }
  ...
  private static class MotherCommand {
    ...
    public MotherCommand(
        int unknown0, int ajPointer, int ajLength, int commandListPointer, int unknown4) {
